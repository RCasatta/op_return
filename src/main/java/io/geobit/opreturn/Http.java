...
public class Http {
    ...
    public static Optional<String> patchJson(String urlString, String jsonString) {
        ...
        return req("POST", urlString, jsonString, "application/json", m);
    }
    ...
    public static Optional<String> postP8G(String urlString, String data, String contentType, String token ) {
        Map<String,String> m = new HashMap<>();
        m.put("token",token);
        return req("POST", urlString, data, contentType, m);
    }

    public static Optional<String> req(String type, String urlString, String dataString, String contentType) {
        return req(type,urlString,dataString,contentType,null);
    }

    public static Optional<String> req(String type, String urlString, String dataString, String contentType, Map<String,String> headers ) {

        try {
            log.info("posting to " + urlString );
